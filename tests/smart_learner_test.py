...
from smart_learner import generate_resets_pairs, generate_row_resets, generate_row_resets_enhance
...
class SmartLearnLearnerTest(unittest.TestCase):
    ...
    def testGenerateRowResets(self):
        test_cases = [
            [(TimedWord('a', 0.5),), (TimedWord('a', 0.5),),
            ({(TimedWord('a',0.5),): False}, {(TimedWord('a',0.5),): True})],
            ...
            {(TimedWord('a',1), TimedWord('a',2),): True})],
            ...
            {(TimedWord('a',1),): True, (TimedWord('a',1), TimedWord('a',2)): False, (TimedWord('a',1), TimedWord('a',1.5)): True}, 
            {(TimedWord('a',1),): True, (TimedWord('a',1), TimedWord('a',2)): True, (TimedWord('a',1), TimedWord('a',1.5)): False}, 
            {(TimedWord('a',1), TimedWord('a',2)): True, (TimedWord('a',1), TimedWord('a',1.5)): True})],
            
            [(TimedWord('a', 1), TimedWord('a', 2)), (TimedWord('a', 1),),
            ({(TimedWord('a',1),): False, (TimedWord('a',1), TimedWord('a',2)): False}, 
            {(TimedWord('a',1),): True, (TimedWord('a',1), TimedWord('a',2)): False}, 
            {(TimedWord('a',1), TimedWord('a',2)): True, (TimedWord('a',1),): True})],
            ...
            {(TimedWord('a',1), TimedWord('a',2)): True, (TimedWord('b',1),): False}, 
            {(TimedWord('a',1), TimedWord('a',2)): True, (TimedWord('b',1),): True})],
        ]
